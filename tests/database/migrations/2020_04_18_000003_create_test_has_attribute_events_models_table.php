...
class CreateTestHasAttributeEventsModelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('test_has_attribute_events_models', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            $table->string('string');
    ...
    {
        Schema::dropIfExists('test_has_attribute_events_models');
    }
}
